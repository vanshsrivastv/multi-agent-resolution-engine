...
If changes made on one device don't appear on another:
...
longer than that and a manual sync doesn't help, the account's sync queue
may be stuck and needs to be cleared on the server side.
